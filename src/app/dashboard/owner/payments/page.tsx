      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-2xl font-bold text-emerald-600 mt-1">{formatCurrency(user.walletBalance || 0)}</p>
          </CardContent>
        </Card>
      </div>
                      ...
                      <tr key={payment.id} className="border-b last:border-0">
                        ...
                        <td className="py-3">
                          <span className="inline-flex items-center gap-1">
                            ...
                            {payment.method === "credit_card" ? t("payments.card") : payment.method === "wallet" ? t("payments.wallet") : payment.method?.toUpperCase()}
                          </span>
                        </td>
                        <td className="py-3 font-medium text-gray-900">{formatCurrency(payment.amount)}</td>
                        <td className="py-3">
